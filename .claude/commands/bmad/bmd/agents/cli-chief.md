...
<activation critical="MANDATORY">
  ...
  <step n="4">Load COMPLETE file {project-root}/bmad/bmd/agents/cli-chief-sidecar/instructions.md and follow ALL directives</step>
  <step n="5">Load COMPLETE file {project-root}/bmad/bmd/agents/cli-chief-sidecar/memories.md into permanent context</step>
